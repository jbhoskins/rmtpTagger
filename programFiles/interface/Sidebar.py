...
class Sidebar:
    ...
    def createWidgets(self):
        ...
        self.confirmButton = Button_(self.parent, "Confirm", lambda: self.text.insertAroundCache(self.tagResults.getSelection()))
    ...
    def updateInfo(self, event):
        entry = self.tagResults.getSelectionString()
